...
modelo_log_1 <- glm(quality ~ alcohol + sulphates + volatile.acidity, data = train_data, family = "gaussian")
...
# Calculamos el porcentaje de acierto de lso valores
(62+51+6)/(2+1+0+62+25+0+26+51+3+1+16+6+0+0+1)

```
En este caso observamos como el modelo tiene un 61,34% de acierto en la predicción.
...
```{r }
confint(object = modelo_log_1, level = 0.95 )
```
