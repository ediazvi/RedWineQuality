...
packages = c('stringr', 'dplyr', 'ggplot2', 'corrplot', 'car', 'vcd', 'rpart', 'rpart.plot', 'tidyverse', 'caret' )
...
for (i in 1:(ncol(subdatos)-1)) {
  hist(subdatos[[i]], xlab = names(subdatos)[i], col = 'lightblue', main = paste("Average =", signif(mean(subdatos[[i]]),3)), breaks = 50)
...
mosaic(matriz_confusion_lm, shade = T, colorize = T, gp = gpar(fill = matrix(c("red2",   "green3",   "red2",   "red2",   "red2",  
...
# Creamos un variable calidad binomial donde especificamos que queremos vinos con valoraciones de 6 o más.
...
modelo_reducido_glm <- glm(quality ~ alcohol + sulphates + volatile.acidity, data = train_data, family = "gaussian")
...
mosaic(matriz_confusion_glm, shade = T, colorize = T, gp = gpar(fill = matrix(c("red2",   "green3",   "red2",   "red2",   "red2",  
                                                                              "red2",   "red2",     "green3", "red2",   "red2", 
                                                                              "red2",   "red2",     "red2",   "green3", "red2"), 5, 3)))
